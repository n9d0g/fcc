    ...
    <footer className="p-4 bg-gray-900 sm:p-6 md:py-[5rem]">
      <div className="container md:flex md:justify-between md:mx-auto">
        <div className="mb-6 md:mb-0">
          <a href="/" className="flex items-center">
            ...
            <span className="self-center text-sm lg:text-2xl font-semibold whitespace-nowrap dark:text-white lg:pr-[10rem]">
        ...
        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-5">
          <div>
            ...
            <ul className="text-gray-600 dark:text-gray-400">
              <FooterListItem href="/about/beliefs" title="Beliefs" />
              <FooterListItem
                href="/about/mission-vision"
                title="Mission & Vision"
              />
              <FooterListItem href="/about/leadership" title="Leadership" />
            </ul>
          </div>
          <div>
            <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">
            ...
            <ul className="text-gray-600 dark:text-gray-400">
              <FooterListItem href="/sermons" title="All Sermons" />
            </ul>
          </div>
          <div>
            <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">
            ...
            <ul className="text-gray-600 dark:text-gray-400">
              <FooterListItem href="/ministries/men" title="Men" />
              <FooterListItem href="/ministries/women" title="Women" />
              <FooterListItem href="/ministries/preteens" title="Preteens" />
              <FooterListItem href="/ministries/youth" title="Youth" />
              <FooterListItem
          ...
          <div>
            ...
            <ul className="text-gray-600 dark:text-gray-400">
              <FooterListItem href="/give" title="Give Online" />
            </ul>
          </div>
        </div>
      </div>
      ...
      <div className="container sm:flex sm:items-center sm:justify-between mx-auto">
        ...
        <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
          <a
            href="https://www.facebook.com/groups/1469254990109982"

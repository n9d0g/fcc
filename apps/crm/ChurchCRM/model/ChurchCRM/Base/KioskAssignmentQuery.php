 ...
 *
 * @method     \ChurchCRM\model\ChurchCRM\KioskDeviceQuery|\ChurchCRM\model\ChurchCRM\EventQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 * @method     ChildKioskAssignment|null findOne(ConnectionInterface $con = null) Return the first ChildKioskAssignment matching the query
 ...
 *
 * @method     ChildKioskAssignment|null findOneById(int $kasm_ID) Return the first ChildKioskAssignment filtered by the kasm_ID column
 * @method     ChildKioskAssignment|null findOneByKioskId(int $kasm_kdevId) Return the first ChildKioskAssignment filtered by the kasm_kdevId column
 * @method     ChildKioskAssignment|null findOneByAssignmentType(int $kasm_AssignmentType) Return the first ChildKioskAssignment filtered by the kasm_AssignmentType column
 * @method     ChildKioskAssignment|null findOneByEventId(int $kasm_EventId) Return the first ChildKioskAssignment filtered by the kasm_EventId column *
...
abstract class KioskAssignmentQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \ChurchCRM\model\ChurchCRM\Base\KioskAssignmentQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\ChurchCRM\\model\\ChurchCRM\\KioskAssignment', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \ChurchCRM\model\ChurchCRM\KioskDevice object
     *
     * @param \ChurchCRM\model\ChurchCRM\KioskDevice|ObjectCollection $kioskDevice The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($kioskDevice instanceof \ChurchCRM\model\ChurchCRM\KioskDevice) {
            return $this
            ...
            throw new PropelException('filterByKioskDevice() only accepts arguments of type \ChurchCRM\model\ChurchCRM\KioskDevice or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \ChurchCRM\model\ChurchCRM\KioskDeviceQuery A secondary query class using the current class as primary query
     */
    public function useKioskDeviceQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinKioskDevice($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'KioskDevice', '\ChurchCRM\model\ChurchCRM\KioskDeviceQuery');
    }

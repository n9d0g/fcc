...
class Person2group2roleP2g2rTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'ChurchCRM.model.ChurchCRM.Map.Person2group2roleP2g2rTableMap';
     ...
     */
    const OM_CLASS = '\\ChurchCRM\\model\\ChurchCRM\\Person2group2roleP2g2r';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'ChurchCRM.model.ChurchCRM.Person2group2roleP2g2r';
  ...
  array (
     ...
     * and findPk*() calls.
     *
     * @param \ChurchCRM\model\ChurchCRM\Person2group2roleP2g2r $obj A \ChurchCRM\model\ChurchCRM\Person2group2roleP2g2r object.
     ...
     *
     * @param mixed $value A \ChurchCRM\model\ChurchCRM\Person2group2roleP2g2r object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \ChurchCRM\model\ChurchCRM\Person2group2roleP2g2r) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \ChurchCRM\model\ChurchCRM\Person2group2roleP2g2r object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \ChurchCRM\model\ChurchCRM\Person2group2roleP2g2r) { // it's a model object

...
class KioskAssignmentTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'ChurchCRM.model.ChurchCRM.Map.KioskAssignmentTableMap';
     ...
     */
    const OM_CLASS = '\\ChurchCRM\\model\\ChurchCRM\\KioskAssignment';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'ChurchCRM.model.ChurchCRM.KioskAssignment';
    ...
    {
        $this->addRelation('KioskDevice', '\\ChurchCRM\\model\\ChurchCRM\\KioskDevice', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':kasm_kdevId',
    1 => ':kdev_ID',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \ChurchCRM\model\ChurchCRM\KioskAssignment) { // it's a model object

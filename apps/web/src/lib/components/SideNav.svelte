...
<!-- Drawer Panel -->
<aside
	class="fixed right-0 top-0 z-50 h-svh w-72 transform bg-white shadow-xl transition-transform duration-300 ease-in-out dark:bg-surface-900 xl:hidden {open
		? 'translate-x-0'
		: 'translate-x-full'}"
>

	...
	<section>
		<div class="my-8 grid grid-cols-1 items-center gap-8 md:grid-cols-2">
			<p class="my-8 text-center text-xl leading-relaxed" data-testid="give-description">
				...
				>. More than being a rule to follow, we give because God is our ultimate provider and gives
				us everything we need to live and do the good work He has called us to do
				<a href={links.verse2} target="_blank" class="anchor font-bold">(2 Corinthians 9:8)</a>. We
				value the discipline of giving our tithes and offerings because it reflects the same
				faithful, generous and gracious heart of our Father.
			</p>

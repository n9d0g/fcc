...
<FccLayout {title} {breadcrumb} {headData}>
	...
	<div class="mb-8">
		<h2 class="h2 mb-4 font-bold">
			Welcome to Brampton Women's Bible Study 2!
		</h2>
		<p class="text-lg">
			Join our community of women in Brampton as we explore God's Word together
			through meaningful Bible study and heartfelt fellowship. Our group offers
			a nurturing space where women can encourage one another, share life's
			journey, and grow deeper in their faith.
		</p>
	</div>
	...
	<div class="mb-8 grid grid-cols-1 gap-4 md:grid-cols-2">
		<div class="card dark:bg-surface-800 bg-white p-5">
			...
			<div class="flex flex-col gap-1 opacity-80">
				<p class="font-semibold">Check with the group for schedule</p>
				<p>Online via Zoom</p>
			</div>
		</div>
	...
	<div class="card dark:bg-surface-800 mb-8 bg-white p-6">
		...
		<p>
			For more information, please reach out to Sister Chrys or visit us on a
			Sunday service.
		</p>
	</div>

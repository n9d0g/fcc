...
<FccLayout {title} {breadcrumb} {headData}>
	...
	<div class="mb-8">
		<h2 class="h2 mb-4 font-bold">
			Welcome to Brampton Women's Bible Study 1!
		</h2>
		<p class="text-lg">
			Join our community of women in Brampton as we grow together in faith
			through Bible study, prayer, and fellowship. Our group provides a warm and
			supportive environment where women can deepen their understanding of
			Scripture and build lasting friendships.
		</p>
	</div>

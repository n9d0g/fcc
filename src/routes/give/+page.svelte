	...
	<section>
		<div class="my-8 grid grid-cols-1 items-center gap-8 md:grid-cols-2">
			<p class="my-8 text-center text-xl leading-relaxed" data-testid="give-description">
				...
				>. More than being a rule to follow, we give because God is our ultimate provider and gives us everything we
				need to live and do the good work He has called us to do

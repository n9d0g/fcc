      ...
      <ol className="container">
        ...
        <div className="navbar-right">
          ...
          <Link
            className="navbar-link"
            to="/about"
            onClick={() => setDocumentTitle('About')}>
            <li className="navbar-option">about</li>
          </Link>
          <Link
            className="navbar-link"
            to="/sermons"
            onClick={() => setDocumentTitle('Sermons')}>
            <li className="navbar-option">sermons</li>
          </Link>
          <Link
            className="navbar-link"
            to="/ministries"
            onClick={() => setDocumentTitle('Ministries')}>
            <li className="navbar-option">ministries</li>
          </Link>
          <Link
            className="navbar-link"
            to="/smallgroups"
            onClick={() => setDocumentTitle('Small Groups')}>
            <li className="navbar-option">small groups</li>
          </Link>
          <Link
            className="navbar-link"
            to="/give"
            onClick={() => setDocumentTitle('Give')}>

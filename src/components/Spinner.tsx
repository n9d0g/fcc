...
const SVGContainer = styled.g`
  ...
  .stem {
    animation: animate-cross 0.5s linear forwards;
  }
  .lowest {
    animation: animate-cross 0.75s linear forwards;
  }
  .lower {
    animation: animate-cross 1s linear forwards;
  }
  .higher {
    animation: animate-cross 1.25s linear forwards;
  }
  .highest {
    animation: animate-cross 1.5s linear forwards;
  }
  #cross {
    animation: animate-cross 0.5s linear forwards;
  ...
  .bird {
    animation: animate-bird 0s linear forwards;
  }
  #logoF {
    animation: animateItem 0s linear forwards;
  }
  #logoR {
    animation: animateItem 0.1s linear forwards;
  }
  #logoE1 {
    animation: animateItem 0.2s linear forwards;
  }
  #logoE2 {
    animation: animateItem 0.3s linear forwards;
  }
  #logoD {
    animation: animateItem 0.4s linear forwards;
  }
  #logoO {
    animation: animateItem 0.5s linear forwards;
  }
  #logoM {
    animation: animateItem 0.6s linear forwards;
  }
  #logoI {
    animation: animateItem 0.7s linear forwards;
  }
  #logoN {
    animation: animateItem 0.8s linear forwards;
  }
  #logoC1 {
    animation: animateItem 0.9s linear forwards;
  }
  #logoH {

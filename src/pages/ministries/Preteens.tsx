...
export const Preteens = () => {
  ...
  const [document]: any = useSinglePrismicDocument('preteens')
      ...
      {document ? (
        <Container initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
          ...
          <Breadcrumb>
            ...
            />
            <BreadcrumbItem
              location={constants.links.ministries.preteens.location}
              title={constants.links.ministries.preteens.text}
              last
            />
          </Breadcrumb>
          <Intro>

...
const ministriesPage: string = 'https://dev.fcccanada.ca/ministries'
const praisePage: string = 'https://dev.fcccanada.ca/ministries/praise'
const schedulePage: string = 'https://dev.fcccanada.ca/ministries/praise/schedule'
